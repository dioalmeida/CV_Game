...
class Game(ShowBase):
    ...
    def setup_level(self):
        ...
        self.wall = self.loader.loadModel("assets/wall.egg")
        
        self.wall.setPos(1,0,FLOOR_Z)
        self.wall.reparentTo(self.render)
        self.wall.setColor(0,0,255,0.5)
        self.wall.setPythonTag("wall", self)
        """
        self.wall2 = self.loader.loadModel("assets/wall.egg")
        
        self.wall2.setPos(1,15,FLOOR_Z)
        self.wall2.reparentTo(self.render)
        self.wall2.setColor(0,0,255,0.5)
        """
        ...
        """
        #self.landingEvent = CollisionHandlerEvent()
        #self.pusher.add_in_pattern("%fn-into-%in")
        self.pusher.addCollider(self.collider, self.sm)
        #self.pusher.addCollider(self.collider, self.wall)
